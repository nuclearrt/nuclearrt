...
public:
    ...
    void WriteCharWide(wchar_t value);
    ...
    void WriteFixedLengthStringWide(const std::wstring& value);
    ...
    template<typename T>
    void WriteSpan(Span<T> data)
    {
        WriteFromMemory(data.Data(), data.Size() * sizeof(T));
    }
